...
public class AssiToHeadTest {
	...
	public static void main(String[] args) throws Throwable {
		...
		String UH=pr.getProperty("unhead");

		String PH=pr.getProperty("pwdhead");

		driver.findElement(By.name("hr_email")).sendKeys(UH);
		Thread.sleep(3000);

		driver.findElement(By.name("hr_password")).sendKeys(PH);
		Thread.sleep(3000);
		WebElement obj3= driver.findElement(By.id("hr_type"));
		Thread.sleep(3000);
		Select obj4=new Select(obj3);

		obj4.selectByValue("HR Head");
